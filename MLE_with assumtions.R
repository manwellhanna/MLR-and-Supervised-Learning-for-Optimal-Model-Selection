...
#note--x1 and x3 have negative correlation
...
# Fit a linear regression model with the transformed response variable "log(mpg)"
...
#391, 691 and 833 are high influance
