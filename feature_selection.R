...
mae_full <- mae(log(test_data$Y), pred_full)
mae_forward <- mae(log(test_data$Y), pred_forward)
mae_backward <- mae(log(test_data$Y), pred_backward)
mae_stepwise <- mae(log(test_data$Y), pred_stepwise)
...
cat("MAE for full model:", mae_full, "\n")
cat("MAE for forward model:", mae_forward, "\n")
cat("MAE for backward model:", mae_backward, "\n")
cat("MAE for stepwise model:", mae_stepwise, "\n")
